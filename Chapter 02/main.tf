...
#Module for creating a new S3 bucket for storing pipeline build artifacts
...
# Module for codeCommit Infrastructure Source code repository
...
# Module for codeBuild Infrastructure Validation - CodeBuild
...
# Module for Terraform Infrastructure Validate, Plan, Apply and Destroy - CodePipeline
